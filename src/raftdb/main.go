...
const (
	DefaultHTTPAddr = "localhost:9300"
	DefaultRaftAddr = "localhost:9222"
)
...
func main() {
	...
	if err := os.MkdirAll(raftDir, 0700); err != nil {
		fmt.Fprintf(os.Stderr, "Raft storage create fail: %+v", err)
		os.Exit(1)
	}
	...
	if err := s.SetMeta(nodeID, httpAddr); err != nil && err != db.ErrNotLeader {
